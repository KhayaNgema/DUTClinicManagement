...
{
    public class RegisterParamedicModel : PageModel
    {
        ...
        private readonly ILogger<RegisterPharmacistModel> _logger;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(doctor, "Paramedic");
                    ...
                    accountCreationEmailBody += $"You have been successfully added as DUT Clnic paramedic. Below are your login credentials:<br><br>";
...
*/
                    ...
                    return RedirectToAction("Paramedics", "Users");
                }
